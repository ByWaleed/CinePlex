...
public class dummyData {
    ...
    public static void createMovies() {
        ...
        movies.add(new Movie(movies.size() + 1, "Batman vs Superman", "Zack Snyder", "Chris Terrio, David S. Goyer", " Ben Affleck, Henry Cavill, Amy Adams", "12A", batmanvsupermanDate, "Fearing that the actions of Superman are left unchecked, Batman takes on the Man of Steel, while the world wrestles with what kind of a hero it really needs. ", "Action, Adventure, Fantasy", 8.5, 12, 5.79, "English", true, "https://m.media-amazon.com/images/M/MV5BYThjYzcyYzItNTVjNy00NDk0LTgwMWQtYjMwNmNlNWJhMzMyXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SX200.jpg", "tt2975590", "14 wins and 33 nominations", "https://www.youtube.com/watch?v=0WWzgGyAH6Y"));
        movies.add(new Movie(movies.size() + 1, "Avengers End Game", "Anthony Russo, Joe Russo", "", "", "", avengersDate, "After the devastating events of Avengers: Infinity War (2018), the universe is in ruins. With the help of remaining allies, the Avengers assemble once more in order to undo Thanos' actions and restore order to the universe. ", "Action, Adventure, Fantasy", 8.7, 10, 6.49, "English", true, "https://m.media-amazon.com/images/M/MV5BNGZiMzBkZjMtNjE3Mi00MWNlLWIyYjItYTk3MjY0Yjg5ODZkXkEyXkFqcGdeQXVyNDg4NjY5OTQ@._V1_SX200.jpg", "tt4154796", "10 wins and 20 nominations", "https://www.youtube.com/watch?v=lLfKgylPkm4"));
        movies.add(new Movie(movies.size() + 1, "Blade Runner 2049", "John Doe", "", "", "", random, "Some random movie.", "Unnknown", 7.5, 16, 12.00, "English", true, "https://m.media-amazon.com/images/M/MV5BNzA1Njg4NzYxOV5BMl5BanBnXkFtZTgwODk5NjU3MzI@._V1_SX200.jpg", "tt1856101", "None", ""));
        movies.add(new Movie(movies.size() + 1, "Star Wars the Last Jedi", "John Doe",  "", "", "", random, "Some random movie.", "Unnknown", 7.3, 16, 12.00, "English", true, "https://m.media-amazon.com/images/M/MV5BMjQ1MzcxNjg4N15BMl5BanBnXkFtZTgwNzgwMjY4MzI@._V1_SX200.jpg", "tt2527336", "None", ""));
        movies.add(new Movie(movies.size() + 1, "Matrix", "John Doe", "", "", "", random, "Some random movie.", "Unnknown", 6.9, 16, 12.00, "English", true, "https://m.media-amazon.com/images/M/MV5BNzQzOTk3OTAtNDQ0Zi00ZTVkLWI0MTEtMDllZjNkYzNjNTc4L2ltYWdlXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_SX200.jpg", "tt0133093", "None", ""));
        movies.add(new Movie(movies.size() + 1, "The Dark Night", "John Doe", "", "", "", random, "Some random movie.", "Unnknown", 8.1, 16, 12.00, "English", true, "https://m.media-amazon.com/images/M/MV5BMTMxNTMwODM0NF5BMl5BanBnXkFtZTcwODAyMTk2Mw@@._V1_SX200.jpg", "tt0468569", "None", ""));
        movies.add(new Movie(movies.size() + 1, "Terminator 2", "John Doe", "", "" , "", random, "Some random movie.", "Unnknown", 8.7, 16, 12.00, "English", true, "https://m.media-amazon.com/images/M/MV5BMGU2NzRmZjUtOGUxYS00ZjdjLWEwZWItY2NlM2JhNjkxNTFmXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_SX200.jpg", "tt0103064", "None", ""));
    ...
    public static void createSessions() {
        ...
        sessions.add(new Session(sessions.size() + 1, movies.get(0).getId(), theatres.get(1).getId(), LocalTime.of(21,00), LocalTime.of(22,00)));
        sessions.add(new Session(sessions.size() + 1, movies.get(0).getId(), theatres.get(1).getId(), LocalTime.of(22,00), LocalTime.of(23,30)));
